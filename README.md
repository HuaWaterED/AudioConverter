...
主要功能为flac转ogg，mp3转ogg，wav转ogg，并同时重采样
如果输入输出都是ogg，那就只执行重采样
...
The main functions are to convert FLAC to OGG, MP3 to OGG, and WAV to OGG, and to resample simultaneously. If both the input and output are OGG, only resampling will be performed. 
